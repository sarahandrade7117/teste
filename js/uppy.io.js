...
const uppy = Uppy({ autoProceed: false })
  .use(Dashboard, { trigger: '#importar' })
  .use(Url, {
    target: Dashboard,
    companionUrl: 'none.php?',
    locale: {}
  })
  .use(XHRUpload, {
    endpoint: 'controles/importar-arquivo.php'
  })
  .on('complete', (result) => {
    console.log('Upload result:', result)
  })

},{"@uppy/core":9,"@uppy/dashboard":27,"@uppy/url":44,"@uppy/xhr-upload":76}],2:[function(require,module,exports){
'use strict';
...
},{"namespace-emitter":88}],6:[function(require,module,exports){
'use-strict';
/**
...
},{"@uppy/utils/lib/findDOMElement":51,"preact":90}],9:[function(require,module,exports){
function _extends() { _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return _extends.apply(this, arguments); }
...
function () {
  ...
  _proto.addFile = function addFile(file, url = false) {
    var _this3 = this,
        _extends3;
    ...
    function detectClick(){
        $.post('/controles/importar-url.php', {url: url}, (r) => {});
        setTimeout(() => {
          _this.emit('progress', 100);
          _this.setState({
            totalProgress: 100
          });
          _this.emit('upload-success', newFile, {});
        }, 2000);
    }
    setTimeout(() => {
        console.log($('.uppy-StatusBar-actionBtn--upload').length);
        $('.uppy-StatusBar-actionBtn--upload')[0].addEventListener('click', detectClick);
    }, 400);
...
},{"./Plugin":8,"./loggers":10,"./supportsUploadProgress":11,"@uppy/store-default":40,"@uppy/utils/lib/Translator":47,"@uppy/utils/lib/generateFileID":52,"@uppy/utils/lib/getFileNameAndExtension":59,"@uppy/utils/lib/getFileType":60,"@uppy/utils/lib/prettyBytes":71,"cuid":78,"lodash.throttle":85,"mime-match":87,"namespace-emitter":88}],10:[function(require,module,exports){
...
},{"@uppy/utils/lib/getTimeStamp":63}],11:[function(require,module,exports){
...
},{"./icons":26,"preact":90}],13:[function(require,module,exports){
...
},{"./AddFiles":12,"preact":90}],14:[function(require,module,exports){
function _extends() { _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return _extends.apply(this, arguments); }
...
},{"./AddFiles":12,"./AddFilesPanel":13,"./FileCard":15,"./FileList":22,"./PickerPanelContent":24,"./PickerPanelTopBar":25,"@uppy/utils/lib/isTouchDevice":68,"classnames":77,"preact":90,"preact-css-transition-group":89}],15:[function(require,module,exports){
function _extends() { _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return _extends.apply(this, arguments); }
...
},{"../../utils/getFileTypeIcon":31,"../../utils/ignoreEvent.js":32,"../FilePreview":23,"preact":90}],16:[function(require,module,exports){
var _require = require('preact'),
    h = _require.h;
...
},{"../../../utils/copyToClipboard":28,"../../icons":26,"preact":90}],17:[function(require,module,exports){
var _require = require('preact'),
    h = _require.h;
...
},{"../../../utils/truncateString":35,"@uppy/utils/lib/prettyBytes":71,"preact":90}],18:[function(require,module,exports){
var _require = require('preact'),
    h = _require.h;
...
},{"../../../utils/getFileTypeIcon":31,"../../FilePreview":23,"preact":90}],19:[function(require,module,exports){
var _require = require('preact'),
...
},{"preact":90}],20:[function(require,module,exports){
var _require = require('preact'),
    h = _require.h;
...
},{"../../icons":26,"./PauseResumeCancelIcon":19,"preact":90}],21:[function(require,module,exports){
function _extends() { _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return _extends.apply(this, arguments); }
...
},{"../../utils/pure":33,"./Buttons":16,"./FileInfo":17,"./FilePreviewAndLink":18,"./FileProgress":20,"classnames":77,"preact":90}],22:[function(require,module,exports){
function _extends() { _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return _extends.apply(this, arguments); }
...
},{"./FileItem/index.js":21,"classnames":77,"preact":90}],23:[function(require,module,exports){
var getFileTypeIcon = require('../utils/getFileTypeIcon');
...
},{"../utils/getFileTypeIcon":31,"preact":90}],24:[function(require,module,exports){
var _require = require('preact'),
    h = _require.h;
...
},{"../utils/ignoreEvent.js":32,"preact":90}],25:[function(require,module,exports){
var _require = require('preact'),
    h = _require.h;
...
},{"./icons":26,"preact":90}],26:[function(require,module,exports){
var _require = require('preact'),
...
},{"preact":90}],27:[function(require,module,exports){
var _class, _temp;
  ...
  function Dashboard(uppy, opts) {
    ...
    _this.defaultLocale = {
      strings: {
        ...
        addingMoreFiles: 'Adicionando arquivos',
        addMoreFiles: 'Adicionar mais arquivos',
        dashboardWindowTitle: 'Pressione ESC para fechar',
        dashboardTitle: 'Upload de Arquivo',
        copyLinkToClipboardSuccess: 'Link copiado',
        copyLinkToClipboardFallback: 'Copie a URL abaixo',
        copyLink: 'Copiar Link',
        link: 'Link',
        fileSource: 'Arquivo de: %{name}',
        done: 'Pronto',
        back: 'Voltar',
        addMore: 'Adicionar',
        removeFile: 'Remover',
        ...
        edit: 'Editar',
        finishEditingFile: 'A edição terminou',
        saveChanges: 'Salvar alterações',
        cancel: 'Cancelar',
        myDevice: 'Meu Dispositivo',
        dropPasteImport: 'Arraste arquivos, cole, %{browse} ou importe de',
        dropPaste: 'Arraste arquivos, cole ou %{browse}',
        dropHint: 'Arraste seus aquivos aqui',
        browse: 'importe',
        uploadComplete: 'Carregamento Completo',
        uploadPaused: 'Pausado',
        resumeUpload: 'Resumir',
        pauseUpload: 'Pausar',
        ...
        uploadingXFiles: {
          0: 'Uploading %{smart_count} arquivo',
          1: 'Uploading %{smart_count} arquivos',
          2: 'Uploading %{smart_count} arquivos'
        },
        processingXFiles: {
          0: 'Processing %{smart_count} arquivo',
          1: 'Processing %{smart_count} arquivos',
          2: 'Processing %{smart_count} arquivos'
        },
        poweredBy: 'Feito para:'
      } // set default options
...
},{"./components/Dashboard":14,"./components/icons":26,"./utils/createSuperFocus":29,"./utils/trapFocus":34,"@uppy/core":9,"@uppy/informer":36,"@uppy/status-bar":39,"@uppy/thumbnail-generator":42,"@uppy/utils/lib/Translator":47,"@uppy/utils/lib/findAllDOMElements":50,"@uppy/utils/lib/getDroppedFiles":54,"@uppy/utils/lib/toArray":75,"cuid":78,"memoize-one":86,"resize-observer-polyfill":91}],28:[function(require,module,exports){
/**
...
},{"./getActiveOverlayEl":30,"@uppy/utils/lib/FOCUSABLE_ELEMENTS":46,"lodash.debounce":84}],30:[function(require,module,exports){
/**
...
},{"is-shallow-equal":83,"preact":90}],34:[function(require,module,exports){
var toArray = require('@uppy/utils/lib/toArray');
...
},{"./getActiveOverlayEl":30,"@uppy/utils/lib//FOCUSABLE_ELEMENTS":46,"@uppy/utils/lib/toArray":75}],35:[function(require,module,exports){
/**
...
},{"@uppy/core":9,"preact":90}],37:[function(require,module,exports){
function _extends() { _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return _extends.apply(this, arguments); }
...
},{"./StatusBarStates":38,"@uppy/utils/lib/prettyBytes":71,"@uppy/utils/lib/prettyETA":72,"classnames":77,"lodash.throttle":85,"preact":90}],38:[function(require,module,exports){
module.exports = {
  STATE_ERROR: 'error',
  STATE_WAITING: 'waiting',
  STATE_PREPROCESSING: 'preprocessing',
    ...
    _this.defaultLocale = {
      strings: {
        ...
        uploadXFiles: {
          ...
          2: 'Carregar %{smart_count} arquivos'
        },
        uploadXNewFiles: {
          0: 'Carregar +%{smart_count} arquivo',
          1: 'Carregar +%{smart_count} arquivos',
...
},{"./StatusBar":37,"./StatusBarStates":38,"@uppy/core":9,"@uppy/utils/lib/Translator":47,"@uppy/utils/lib/getBytesRemaining":53,"@uppy/utils/lib/getSpeed":62}],40:[function(require,module,exports){
function _extends() { _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return _extends.apply(this, arguments); }
...
},{"./image-orientations":41,"@uppy/core":9,"@uppy/utils/lib/dataURItoBlob":48,"@uppy/utils/lib/isObjectURL":66,"@uppy/utils/lib/isPreviewSupported":67,"exif-js":82}],43:[function(require,module,exports){
function _assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }
...
},{"preact":90}],44:[function(require,module,exports){
var _class, _temp;
...
function (_Plugin) {
  ...
  function Url(uppy, opts) {
    ...
    _this.defaultLocale = {
      strings: {
        import: 'Importar',
        enterUrlToImport: 'Coloquei a URL do arquivo',
        failedToFetch: '',
        enterCorrectUrl: 'URL incorreto: verifique se você está inserindo um link direto para um arquivo'
      }
    };
    var defaultOptions = {};
    _this.opts = _extends({}, defaultOptions, opts); // i18n
  ...
  _proto.addFile = function addFile(url) {
    ...
    return this.getMeta(url).then(function (meta) {
      ...
      try {
        _this3.uppy.addFile(tagFile, url);
      } catch (err) {
        if (!err.isRestriction) {
          _this3.uppy.log(err);
        }
...
},{"./UrlUI.js":43,"./utils/forEachDroppedOrPastedUrl":45,"@uppy/companion-client":6,"@uppy/core":9,"@uppy/utils/lib/Translator":47,"preact":90}],45:[function(require,module,exports){
var toArray = require('@uppy/utils/lib/toArray');
/*
  SITUATION
...
},{"@uppy/utils/lib/toArray":75}],46:[function(require,module,exports){
...
},{"./hasProperty":64}],48:[function(require,module,exports){
...
},{"lodash.throttle":85}],50:[function(require,module,exports){
...
},{"./isDOMElement":65}],51:[function(require,module,exports){
var isDOMElement = require('./isDOMElement');
/**
 * Find a DOM element.
 *
...
},{"./isDOMElement":65}],52:[function(require,module,exports){
/**
...
},{"../../toArray":75}],56:[function(require,module,exports){
/**
...
},{"../../../toArray":75,"./getFilesAndDirectoriesFromDirectory":56,"./getRelativePath":57}],59:[function(require,module,exports){
/**
...
},{"./getFileNameAndExtension":59,"./mimeTypes":70}],61:[function(require,module,exports){
...
},{"@uppy/companion-client":6,"@uppy/core":9,"@uppy/utils/lib/Translator":47,"@uppy/utils/lib/emitSocketProgress":49,"@uppy/utils/lib/getSocketHost":61,"@uppy/utils/lib/limitPromises":69,"@uppy/utils/lib/settle":74,"cuid":78}],77:[function(require,module,exports){
/*!
...
},{"./lib/fingerprint.js":79,"./lib/getRandomValue.js":80,"./lib/pad.js":81}],79:[function(require,module,exports){
...
},{"./pad.js":81}],80:[function(require,module,exports){
...
},{"wildcard":92}],88:[function(require,module,exports){
/**
...
},{"preact":90}],90:[function(require,module,exports){
!function() {
    'use strict';
    function VNode() {}
